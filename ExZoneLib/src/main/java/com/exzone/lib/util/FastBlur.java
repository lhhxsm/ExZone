...
public class FastBlur {
  ...
  public static Bitmap doBlur(Bitmap sentBitmap, int radius, boolean canReuseInBitmap) {
    ...
    Logger.e("虚化后:" + String.format("  width=%s,", bitmap.getWidth()));
    Logger.e("虚化后:" + String.format("  height=%s,", bitmap.getHeight()));
    return (bitmap);
  }
  ...
  public static Bitmap doBlur(Bitmap originBitmap, int scaleRatio, int blurRadius) {
    Logger.e("原图:" + String.format("  width=%s,", originBitmap.getWidth()));
    Logger.e("原图:" + String.format("  height=%s,", originBitmap.getHeight()));
    Bitmap scaledBitmap =
