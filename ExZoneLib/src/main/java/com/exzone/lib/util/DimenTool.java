    ...
    try {
      ...
      while ((tempString = reader.readLine()) != null) {
        if (tempString.contains("</dimen>")) {
          ...
          int num = Integer.parseInt(tempString.substring(tempString.indexOf(">") + 1,
              tempString.indexOf("</dimen>") - 2));
          DecimalFormat df = new DecimalFormat("0.000");
          sw320land.append(start)
              .append(df.format(1.0f * num * (1.0f * 320 / 800)))
              .append(end)
              .append("\n");
          sw480land.append(start)
              .append(df.format(1.0f * num * (1.0f * 480 / 800)))
              .append(end)
              .append("\n");
          sw600land.append(start)
              .append(df.format(1.0f * num * (1.0f * 600 / 800)))
              .append(end)
              .append("\n");
          sw720land.append(start)
              .append(df.format(1.0f * num * (1.0f * 720 / 800)))
              .append(end)
              .append("\n");
          sw800land.append(start)
              .append(df.format(1.0f * num * (1.0f * 800 / 800)))
              .append(end)
              .append("\n");
          sw1028land.append(start)
              .append(df.format(1.0f * num * (1.0f * 1028 / 800)))
              .append(end)
              .append("\n");
          sw1280land.append(start)
              .append(df.format(1.0f * num * (1.0f * 1280 / 800)))
              .append(end)
              .append("\n");
          //                    w820.append(tempString).append("\n");
          w240.append(start)
              .append(df.format(1.0f * num * (1.0f * 240 / 320)))
              .append(end)
              .append("\n");
          w320.append(start)
              .append(df.format(1.0f * num * (1.0f * 320 / 320)))
              .append(end)
              .append("\n");
          w480.append(start)
              .append(df.format(1.0f * num * (1.0f * 480 / 320)))
              .append(end)
              .append("\n");
          w600.append(start)
              .append(df.format(1.0f * num * (1.0f * 600 / 320)))
              .append(end)
              .append("\n");
          w720.append(start)
              .append(df.format(1.0f * num * (1.0f * 720 / 320)))
              .append(end)
              .append("\n");
          w800.append(start)
              .append(df.format(1.0f * num * (1.0f * 800 / 320)))
              .append(end)
              .append("\n");
        } else {
