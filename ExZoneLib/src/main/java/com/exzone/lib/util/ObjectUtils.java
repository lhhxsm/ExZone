...
public final class ObjectUtils {
  ...
  @NonNull public static <T> Func1<T, T> coalesceWith(final @NonNull T theDefault) {
    return new Func1<T, T>() {
      @Override public T call(T value) {
  ...
  /**
   * Cast a `null`able value into a non-`null` value, and throw a `NullPointerException` if the
   * value is `null`.
   */
  ...
  /**
   * Cast a `null`able value into a non-`null` value, and throw a `NullPointerException` if the
   * value is `null`. Provide
   * a message for a better description of why you require this value to be non-`null`.
   */
  public static @NonNull <T> T requireNonNull(final @Nullable T value,
      final @NonNull Class<T> klass) throws NullPointerException {
   ...
   */
  public static @NonNull <T> T requireNonNull(final @Nullable T value,
      final @NonNull String message) throws NullPointerException {
    if (value == null) {
