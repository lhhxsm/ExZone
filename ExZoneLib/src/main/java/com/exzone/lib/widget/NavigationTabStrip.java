...
/**
 * 作者:李鸿浩
 * 描述:导航标签条平滑交互的效果.https://github.com/DevLight-Mobile-Agency/NavigationTabStrip
 * 时间:2016/7/11.
 */
public class NavigationTabStrip extends View implements ViewPager.OnPageChangeListener {
  ...
  @Override protected void onConfigurationChanged(final Configuration newConfig) {
  ...
  private static class ResizeInterpolator implements Interpolator {
    ...
    @Override public float getInterpolation(final float input) {
      if (mResizeIn) {
