...
public class VerticalDividerItemDecoration extends FlexibleDividerDecoration {
  ...
  @Override protected Rect getDividerBound(int position, RecyclerView parent, View child) {
    ...
    HeaderAndFooterRecyclerViewAdapter mAdapter =
        (HeaderAndFooterRecyclerViewAdapter) parent.getAdapter();
    ...
    bounds.bottom =
        parent.getHeight() - parent.getPaddingBottom() - mMarginProvider.dividerBottomMargin(
            position, parent) + transitionY;
