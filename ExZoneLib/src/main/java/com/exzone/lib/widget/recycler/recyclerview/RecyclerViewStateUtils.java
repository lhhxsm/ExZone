package com.exzone.lib.widget.recycler.recyclerview;
...
public class RecyclerViewStateUtils {
  ...
  public static void setFooterViewState(Activity instance, RecyclerView recyclerView,
      boolean mHasMore, RecyclerViewLoadingFooter.State state, View.OnClickListener errorListener) {
  ...
  public static RecyclerViewLoadingFooter.State getFooterViewState(RecyclerView recyclerView) {
    ...
    if (outerAdapter != null && outerAdapter instanceof HeaderAndFooterRecyclerViewAdapter) {
      if (((HeaderAndFooterRecyclerViewAdapter) outerAdapter).getFooterViewsCount() > 0) {
        RecyclerViewLoadingFooter footerView =
            (RecyclerViewLoadingFooter) ((HeaderAndFooterRecyclerViewAdapter) outerAdapter).getFooterView();
