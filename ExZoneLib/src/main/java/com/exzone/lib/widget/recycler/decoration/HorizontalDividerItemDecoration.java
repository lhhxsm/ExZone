package com.exzone.lib.widget.recycler.decoration;
...
public class HorizontalDividerItemDecoration extends FlexibleDividerDecoration {
  ...
  @Override protected Rect getDividerBound(int position, RecyclerView parent, View child) {
    ...
    bounds.left =
        parent.getPaddingLeft() + mMarginProvider.dividerLeftMargin(position, parent) + transitionX;
    bounds.right =
        parent.getWidth() - parent.getPaddingRight() - mMarginProvider.dividerRightMargin(position,
            parent) + transitionX;
