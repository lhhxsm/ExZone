...
public class ExGridLayoutManager extends GridLayoutManager {
  ...
  public ExGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
      int defStyleRes) {
  ...
  public ExGridLayoutManager(Context context, int spanCount, int orientation,
