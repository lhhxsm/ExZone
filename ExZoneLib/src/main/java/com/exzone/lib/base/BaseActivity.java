...
public abstract class BaseActivity extends AppCompatActivity {
  ...
  @Override public void onBackPressed() {
    ...
    ToastUtils.showShort(this,
        this.getResources().getString(R.string.press_the_key_again_to_close_the_program));
    Observable.just(null).delay(2, TimeUnit.SECONDS).subscribe(new Action1<Object>() {
