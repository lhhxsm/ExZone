...
public class ZoomableImageView extends AppCompatImageView {
  ...
  private void drag(PointF current) {
    float deltaX =
        getMoveDraggingDelta(current.x - last.x, viewWidth, afterScaleDrawableWidth * currentScale);
  ...
  /**
   * This method permits to keep drag and zoom inside the drawable. It makes sure the drag is
   * staying in bound.
   */
