...
public class DropDownMenu extends LinearLayout {
  ...
  //tab选中颜色
  private int textSelectedColor = getResources().getColor(R.color.text_primary);
  //tab未选中颜色
  private int textUnselectedColor = getResources().getColor(R.color.text_secondary);
  //遮罩颜色
  ...
  public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    textUnselectedColor =
        a.getColor(R.styleable.DropDownMenu_textUnselectedColor, textUnselectedColor);
    menuBackgroundColor =
        a.getColor(R.styleable.DropDownMenu_menuBackgroundColor, menuBackgroundColor);
    ...
    menuUnselectedIcon =
        a.getResourceId(R.styleable.DropDownMenu_menuUnselectedIcon, menuUnselectedIcon);
    a.recycle();
