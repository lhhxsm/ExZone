...
public class BottomTabRadioButton extends AppCompatRadioButton {
  ...
  private void initView(AttributeSet attrs) {
    ...
    hint_top_padding =
        ta.getDimensionPixelSize(R.styleable.BottomTabRadioButton_hint_top_padding, 0);
    hint_right_padding =
        ta.getDimensionPixelSize(R.styleable.BottomTabRadioButton_hint_right_padding, 0);

    float defaultPointRadius =
        TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_POINT_RADIUS, metrics);
    ...
    float defaultNumRadius =
        TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_NUM_RADIUS, metrics);
    num_radius = ta.getDimensionPixelSize(R.styleable.BottomTabRadioButton_num_radius,
        (int) (defaultNumRadius + 0.5f));
    float defaultNumSize =
        TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, DEFAULT_NUM_SIZE, metrics);
