...
public class SlideBottomPanel extends FrameLayout {
    ...
    public SlideBottomPanel(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPanelHeight = a.getDimension(R.styleable.SlideBottomPanel_sbp_panel_height, ScreenUtils.dp2px(mContext, DEFAULT_PANEL_HEIGHT));
        mBoundary = a.getBoolean(R.styleable.SlideBottomPanel_sbp_boundary, DEFAULT_BOUNDARY);
        MAX_CLICK_DISTANCE = mTitleHeightNoDisplay = a.getDimension(R.styleable.SlideBottomPanel_sbp_title_height_no_display, ScreenUtils.dp2px(mContext, DEFAULT_TITLE_HEIGHT_NO_DISPLAY));
        mMoveDistanceToTrigger = a.getDimension(R.styleable.SlideBottomPanel_sbp_move_distance_trigger, ScreenUtils.dp2px(mContext, DEFAULT_MOVE_DISTANCE_TO_TRIGGER));
